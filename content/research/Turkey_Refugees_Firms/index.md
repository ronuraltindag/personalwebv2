...
- icon: newspaper
  icon_pack: far
  name: "VoxDevLit: Informality"
  url: https://voxdev.org/voxdevlit/informality-issue-2/determinants-informality
- icon: newspaper
  icon_pack: far
  name: "VoxDevLit: Refugees"
  url: https://voxdev.org/voxdevlit/refugees-and-other-forcibly-displaced-populations/how-forced-migration-affects-hosts
- icon: file-alt
  icon_pack: far
  name: World Bank WDR 2023 case study
  group: press
  url: https://thedocs.worldbank.org/en/doc/a007833298df4b9c3735602711dd9289-0050062023/original/WDR2023-Turkey-case-study-FORMATTED.pdf
- icon: file-alt
  icon_pack: far
  name: JDC literature review
  group: press
  url: https://www.jointdatacenter.org/literature_review/blessing-or-burden-impacts-of-refugees-on-businesses-and-the-informal-economy/
---
