...
\ifdefined\honors
  ...
  \newcommand{\mindtapaccess}{4:00 AM (UTC) on 9/14/2026}
\else
...
Announcements go out through Brightspace, which forwards to your Bentley email; check both regularly. Slides, lecture notes, handouts, and mock exams are posted on the course page above after each class. When you email me, put \textbf{EC111} in the subject line.
...
\textbf{Weather and closures.} If the university cancels classes, I will post on Brightspace whether there is an alternative assignment or arrangement for that day.
...
\begin{itemize}
    ...
    \item \textbf{Week 10 (Nov 2, 4):} The Costs of Production – Ch. 13
    \item \textbf{Week 11 (Nov 9, 11):} Review / \textbf{Second Midterm (Nov 11)}
    \item \textbf{Week 12 (Nov 16, 18):} Firms in Competitive Markets – Ch. 14
    \item \textbf{Week 13 (Nov 23):} Monopoly – Ch. 15 \textit{(no class Nov 25, Thanksgiving Break)}
    \item \textbf{Week 14 (Nov 30, Dec 2):} Monopolistic Competition – Ch. 16 \& Oligopoly – Ch. 17
    \item \textbf{Week 15 (Dec 7):} Review
    \item \textbf{Final Exam:} \finaltime
\end{itemize}

\textit{Note: Chapter references are from Mankiw's Principles of Microeconomics. The schedule, and if necessary other parts of this syllabus, may change during the semester; changes are announced in class and on Brightspace.}
