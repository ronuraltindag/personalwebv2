...
\textit{Note: Chapter references are from Mankiw's \textit{Principles of Microeconomics}, 10th edition (the MindTap e-book). The schedule, and if necessary other parts of this syllabus, may change during the semester; changes are announced in class and on Brightspace.}
