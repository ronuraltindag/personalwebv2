...
\begin{center}
{\LARGE \textbf{Handout 6: Inference and Binary Regressors}} \\[4pt]
{\LARGE \textcolor{cyan}{\textbf{ANSWER KEY}}} \\[8pt]
...
So checking whether $\beta_{1,0} = 0$ falls inside the 95\% CI is equivalent to running the two-sided t-test at $\alpha = 0.05$.
\end{answer}
